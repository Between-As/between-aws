resource "aws_ssm_parameter" "postgres_host" {
  name  = "/${local.tag_environment}/AURORA_POSTGRESHOST"
  type  = "String"
...
resource "aws_ssm_parameter" "postgres_port" {
  name  = "/${local.tag_environment}/AURORA_POSTGRESPORT"
  type  = "String"
...
resource "aws_ssm_parameter" "postgres_master_user" {
  name  = "/${local.tag_environment}/AURORA_POSTGRESUSER"
  type  = "String"
...
resource "aws_ssm_parameter" "postgres_master_pass" {
  name  = "/${local.tag_environment}/AURORA_POSTGRESPASS"
  type  = "SecureString"
